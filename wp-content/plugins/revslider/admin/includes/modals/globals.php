    ...
    <sr-modal-content>
        ...
        <sr-wrap view="glbls_2" viewchild="glbls" class="sr--tab--content" id="sr_gl_bpoints">
            <sr-wrap class="sr--p--20--15">
                ...
                <sr-sp h="15"></sr-sp>
                <sr-info><span class="sr--text"><?php echo __('A breakpoint is the width its device layout applies to: screens narrower than the Desktop breakpoint use the Desktop design, narrower than Notebook use the Notebook design, and so on — on your live pages, not only on the editor stage.','revslider');?> <?php echo __('The five values have to descend, so each field stops just below the one above it: to give a breakpoint more room, raise its neighbour first.','revslider');?><br><br><?php echo __('Wide Screen has no breakpoint of its own — it covers everything above the Desktop breakpoint. Its width only sets how wide the editor canvas is while you design that size.','revslider');?><br><br><?php echo __('To line a breakpoint up with a CSS media query, enter one pixel more than its max-width — a page that switches at max-width: 767px needs 768 here.','revslider');?></span></sr-info>
                <sr-sp h="15"></sr-sp>
                <sr-input twothird class="sr--icon--left--c"><input name="Wide Desktop" viewchild="glbls_2"  r="breakPoints.0" class="sr--pl--50" type="text" placeholder="1920px" validate="true" min="320" max="3840" number="true" suffix="px" fallback="1920" data-onchange="B.globals.breakPoints.sync"><span noicon class="sr--form--otitle"><?php echo __('Wide Screen Design Width','revslider');?></span><span class="sr--input--icon"><svg width="24" height="14" transform="translate(0, 2)"><use xlink:href="#Top_Bar_Wide_Desktop"></use></svg></span></sr-input>
                <sr-input twothird class="sr--icon--left--c"><input name="Desktop" viewchild="glbls_2"  r="breakPoints.1" class="sr--pl--50" type="text" placeholder="1240px" validate="true" min="320" max="3840" number="true" suffix="px" fallback="1240" data-onchange="B.globals.breakPoints.sync"><span noicon class="sr--form--otitle"><?php echo __('Desktop Breakpoint','revslider');?></span><span class="sr--input--icon"><svg width="22" height="18" transform="translate(0, 4)"><use xlink:href="#Top_Bar_Regular_Desktop"></use></svg></span></sr-input>
                <sr-input twothird class="sr--icon--left--c"><input name="Notbeook" viewchild="glbls_2"  r="breakPoints.2" class="sr--pl--50" type="text" placeholder="1024px" validate="true" min="320" max="3840" number="true" suffix="px" fallback="1024" data-onchange="B.globals.breakPoints.sync"><span noicon class="sr--form--otitle"><?php echo __('Notebook Breakpoint','revslider');?></span><span class="sr--input--icon"><svg width="22" height="16" transform="translate(0, 4)"><use xlink:href="#Top_Bar_Laptop"></use></svg></span></sr-input>
                <sr-input twothird class="sr--icon--left--c"><input name="Tablet" viewchild="glbls_2"  r="breakPoints.3" class="sr--pl--50" type="text" placeholder="778px" validate="true" min="320" max="3840" number="true" suffix="px" fallback="778" data-onchange="B.globals.breakPoints.sync"><span noicon class="sr--form--otitle"><?php echo __('Tablet Breakpoint','revslider');?></span><span class="sr--input--icon"><svg width="20" height="24" transform="translate(0, 3)"><use xlink:href="#Top_Bar_Tablet"></use></svg></span></sr-input>
                <sr-input twothird class="sr--icon--left--c"><input name="Mobile" viewchild="glbls_2"  r="breakPoints.4" class="sr--pl--50" type="text" placeholder="480px" validate="true" min="320" max="3840" number="true" suffix="px" fallback="480" data-onchange="B.globals.breakPoints.sync"><span noicon class="sr--form--otitle"><?php echo __('Mobile Breakpoint','revslider');?></span><span class="sr--input--icon"><svg width="14" height="20" transform="translate(0, 5)"><use xlink:href="#Top_Bar_Phone"></use></svg></span></sr-input>
                <sr-sp h="15"></sr-sp>
